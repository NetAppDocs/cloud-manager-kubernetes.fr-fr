...
Connecteur BlueXP:: Un connecteur doit être exécuté dans AWS avec les autorisations requises.  a Connector,Pour en savoir plus.
...
Autorisation RBAC:: Le rôle BlueXP Connector doit être autorisé sur chaque cluster Kubernetes.  up RBAC authorization,Pour en savoir plus.
